 ...
 */
export function userSayNewRandom(
  client: PetstoreCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SayNewRandomResponseBody,
...
> {
  const path = pathToFunc("/new_random")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SayNewRandomResponseBody$inboundSchema),
